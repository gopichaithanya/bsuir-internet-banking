...
public interface IAuthenticationService {
    ...
    @RequestWrapper(localName = "Authenticate", targetNamespace = "http://tempuri.org/", className = "by.bsuir.banking.dotnetclient.Authenticate")
    @ResponseWrapper(localName = "AuthenticateResponse", targetNamespace = "http://tempuri.org/", className = "by.bsuir.banking.dotnetclient.AuthenticateResponse")
