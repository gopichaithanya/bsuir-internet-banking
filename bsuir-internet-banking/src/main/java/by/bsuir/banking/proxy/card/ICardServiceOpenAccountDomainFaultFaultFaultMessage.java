...
public class ICardServiceOpenAccountDomainFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICardServiceOpenAccountDomainFaultFaultFaultMessage(String message, DomainFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICardServiceOpenAccountDomainFaultFaultFaultMessage(String message, DomainFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
