...
public class ICardServiceCloseAccountDomainFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICardServiceCloseAccountDomainFaultFaultFaultMessage(String message, DomainFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICardServiceCloseAccountDomainFaultFaultFaultMessage(String message, DomainFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
