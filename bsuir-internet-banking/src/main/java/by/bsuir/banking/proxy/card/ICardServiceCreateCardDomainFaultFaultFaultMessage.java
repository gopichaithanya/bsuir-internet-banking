...
public class ICardServiceCreateCardDomainFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICardServiceCreateCardDomainFaultFaultFaultMessage(String message, DomainFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICardServiceCreateCardDomainFaultFaultFaultMessage(String message, DomainFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
