...
public class MessageValidation {
	...
	public static final String MIN_AMOUNT = "Минимальная сумма платежа 1.00 бел. рубль";
	public static final String WRONG_PHONE_NUMBER_FORMAT = "Неверный формат. Формат для номера телефона (yyy)xxxxxxx. yyy - код";
