...
public class IInternetBankingServiceGetCardsAuthorizationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IInternetBankingServiceGetCardsAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IInternetBankingServiceGetCardsAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
