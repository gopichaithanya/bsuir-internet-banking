...
public class IInternetBankingServiceGetClientAuthorizationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IInternetBankingServiceGetClientAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IInternetBankingServiceGetClientAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
