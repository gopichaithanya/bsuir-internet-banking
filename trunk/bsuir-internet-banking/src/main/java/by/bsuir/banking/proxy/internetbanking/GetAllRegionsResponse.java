 ...
 *       &lt;sequence>
 *         &lt;element name="GetAllRegionsResult" type="{http://schemas.datacontract.org/2004/07/InternetBanking.DAL.Model}ArrayOfRegion" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllRegionsResponse {
    ...
    @XmlElementRef(name = "GetAllRegionsResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    ...
    public void setGetAllRegionsResult(JAXBElement<ArrayOfRegion> value) {
        this.getAllRegionsResult = ((JAXBElement<ArrayOfRegion> ) value);
    }
