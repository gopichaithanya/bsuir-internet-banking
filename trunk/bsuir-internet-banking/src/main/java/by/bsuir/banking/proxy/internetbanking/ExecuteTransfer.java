...
@XmlRootElement(name = "ExecuteTransfer")
public class ExecuteTransfer {
    ...
    @XmlElementRef(name = "receiverCardNumber", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> receiverCardNumber;
     ...
     *     
     */
    public JAXBElement<String> getReceiverCardNumber() {
     ...
     *     
     */
    public void setReceiverCardNumber(JAXBElement<String> value) {
        this.receiverCardNumber = ((JAXBElement<String> ) value);
    }
