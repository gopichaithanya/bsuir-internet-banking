...
public class IInternetBankingServicePayAuthorizationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IInternetBankingServicePayAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IInternetBankingServicePayAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
