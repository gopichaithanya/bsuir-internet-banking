...
public class Pay {
    ...
    @XmlElementRef(name = "receiverAccountNumber", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> receiverAccountNumber;
     ...
     *     
     */
    public JAXBElement<String> getReceiverAccountNumber() {
     ...
     *     
     */
    public void setReceiverAccountNumber(JAXBElement<String> value) {
        this.receiverAccountNumber = ((JAXBElement<String> ) value);
    }
