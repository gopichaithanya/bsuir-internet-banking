...
public class MoneyValidator implements Validator {
	...
	private static final String WRONG_NUMBER_FORMAT_PATTERN = "0{1}[0-9]?((\\.|\\,)?[0-9]+)?";
	...
	public void validate(Object target, Errors errors) {
		...
		if (money.getEnteredAmount() == null) {
			...
			errors.rejectValue(AMOUNT_FIELD, MessageValidation.NULL_VALUE, MessageValidation.WRONG_MONEY_FORMAT);
