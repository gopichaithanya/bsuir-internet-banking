...
@XmlType(name = "CurrencyType", namespace = "http://schemas.datacontract.org/2004/07/InternetBanking.DAL.Model", propOrder = {
    "id",
    "name",
    "shortName"
})
public class CurrencyType {
    ...
    @XmlElementRef(name = "ShortName", namespace = "http://schemas.datacontract.org/2004/07/InternetBanking.DAL.Model", type = JAXBElement.class)
