...
public class ObjectFactory {
    ...
    private final static QName _SetAmountLimitSecurityToken_QNAME = new QName("http://tempuri.org/", "securityToken");
    ...
    public JAXBElement<String> createSetAmountLimitSecurityToken(String value) {
        return new JAXBElement<String>(_SetAmountLimitSecurityToken_QNAME, String.class, SetAmountLimit.class, value);
    }
    ...
    public JAXBElement<String> createSetOperationLimitSecurityToken(String value) {
        return new JAXBElement<String>(_SetAmountLimitSecurityToken_QNAME, String.class, SetOperationLimit.class, value);
    }
    ...
    public JAXBElement<String> createGetCardSecurityToken(String value) {
        return new JAXBElement<String>(_SetAmountLimitSecurityToken_QNAME, String.class, GetCard.class, value);
    }
    ...
    public JAXBElement<String> createGetBallanceSecurityToken(String value) {
        return new JAXBElement<String>(_SetAmountLimitSecurityToken_QNAME, String.class, GetBallance.class, value);
    }
    ...
    public JAXBElement<String> createGetCardsSecurityToken(String value) {
        return new JAXBElement<String>(_SetAmountLimitSecurityToken_QNAME, String.class, GetCards.class, value);
    }
