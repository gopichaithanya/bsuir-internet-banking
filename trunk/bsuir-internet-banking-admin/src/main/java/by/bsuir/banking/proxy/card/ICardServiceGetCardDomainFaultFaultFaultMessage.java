...
public class ICardServiceGetCardDomainFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICardServiceGetCardDomainFaultFaultFaultMessage(String message, DomainFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICardServiceGetCardDomainFaultFaultFaultMessage(String message, DomainFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
