...
public class IInternetBankingServicePayERIPAuthorizationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IInternetBankingServicePayERIPAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IInternetBankingServicePayERIPAuthorizationFaultFaultFaultMessage(String message, AuthorizationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
