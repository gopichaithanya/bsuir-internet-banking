...
public class ICardServiceGetAllCardTypesDomainFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ICardServiceGetAllCardTypesDomainFaultFaultFaultMessage(String message, DomainFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ICardServiceGetAllCardTypesDomainFaultFaultFaultMessage(String message, DomainFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
