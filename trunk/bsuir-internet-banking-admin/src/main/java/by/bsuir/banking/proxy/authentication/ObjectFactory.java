 ...
 * generated in the by.bsuir.banking.proxy.authentication package. 
...
public class ObjectFactory {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/InternetBanking.DAL.Model", name = "AuthenticationCredential")
    public JAXBElement<AuthenticationCredential> createAuthenticationCredential(AuthenticationCredential value) {
        return new JAXBElement<AuthenticationCredential>(_AuthenticationCredential_QNAME, AuthenticationCredential.class, null, value);
    }
