 ...
 * generated in the by.bsuir.banking.proxy.lockcard package. 
...
public class ObjectFactory {
    ...
    private final static QName _LockCardSecurityToken_QNAME = new QName("http://tempuri.org/", "securityToken");
    ...
    public JAXBElement<String> createLockCardSecurityToken(String value) {
        return new JAXBElement<String>(_LockCardSecurityToken_QNAME, String.class, LockCard.class, value);
    }
    ...
    public JAXBElement<String> createUnlockCardSecurityToken(String value) {
        return new JAXBElement<String>(_LockCardSecurityToken_QNAME, String.class, UnlockCard.class, value);
    }
