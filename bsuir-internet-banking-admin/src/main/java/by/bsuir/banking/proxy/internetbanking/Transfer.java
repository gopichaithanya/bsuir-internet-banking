...
@XmlType(name = "Transfer", namespace = "http://schemas.datacontract.org/2004/07/InternetBanking.DAL.Model", propOrder = {
    "accountId",
    "amount",
    "dateTime",
    "id",
...
public class Transfer {
     ...
     *     
     */
    public void setReceiverAccountId(Integer value) {
